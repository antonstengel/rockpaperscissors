...
if(name == "null"){ //if there is no name
    showOrNot(document.getElementById("play_div"), false); //make play_game hidden
    showOrNot(document.getElementById("name_div"), true); //make enter_name visible
    console.log("no name yet entered");
} else {  //if there already is a name
...
document.getElementById("throw_choice_button").addEventListener("click", function(){
    ...
    if (player_choice == "") {
    ...
    } else { //if a choice is actually made
        ...
        if (browser_choice_number == 0) {
            ...
            console.log("browser chooses scissors");
        }
        ...
        winOrLose(player_choice, browser_choice); //decides winner
            
        displayStats(); //display the stats
        setImg(); //set the images for results
        
        showOrNot(document.getElementById("results_div"), true); //show results
        showOrNot(document.getElementById("play_div"), false); //hide play
...
function winOrLose(player_choice, browser_choice){
    ...
    if (winner) { 
        document.getElementById("throw_results_text").innerHTML = "Player chooses: " + player_choice + "<br> Browser chooses: " + browser_choice + "<br>" + winner + " wins!";
    } else {
...
function setFeedback(){
    ...
    if(name == "null"){
        ...
        feedback_text.innerHTML = "Enter a name to proceed."
        
    } else {
        feedback_text.style.color = "green";
        feedback_text.innerHTML = "You're name has been successfully saved";
    }
}
